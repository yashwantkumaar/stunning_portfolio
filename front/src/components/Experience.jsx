    ...
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center  h-full text-white">
        ...
        <div className="w-full sm:w-full md:w-12/12 mt-5">
          {/* Adding Zeckho Internship */}
          <div
            className="relative flex flex-col p-3.5 border-white md:border-b-4 border-l-4 md:items-start"
            data-aos="fade-up"
            data-aos-duration="800"
          >
            <h1 className="absolute top-0 bg-white w-max p-2.5 text-[#3A1078] dark:text-[#21073C] shadow-2xl text-2xl">
              2024
            </h1>
            <h1 className="pt-14 font-bold text-3xl">Zeckho</h1>
            <h2 className="text-xl font-bold text-[#00FFCA] py-1">Intern</h2>
            <p className="text-lg mt-1 leading-8">
              Gained hands-on experience in web development, working with modern
              technologies and frameworks to build scalable applications.
            </p>
          </div>
